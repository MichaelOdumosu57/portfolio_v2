...
describe('IntroMainComponent', () => {
  let cpnt: IntroMainComponent;
  let fixture: ComponentFixture<IntroMainComponent>;

  beforeEach(async () => {
    await configureTestingModuleForComponents(IntroMainComponent,{mockTranslateService});
    ({fixture, cpnt} =  grabComponentInstance(IntroMainComponent));
