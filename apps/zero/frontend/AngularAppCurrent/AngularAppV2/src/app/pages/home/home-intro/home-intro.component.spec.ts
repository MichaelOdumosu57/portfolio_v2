...
describe('HomeIntroComponent', () => {
  let cpnt: HomeIntroComponent;
  let fixture: ComponentFixture<HomeIntroComponent>;

  beforeEach(async () => {
    await configureTestingModuleForComponents(HomeIntroComponent,{mockTranslateService});
    ({fixture, cpnt} =  grabComponentInstance(HomeIntroComponent));
