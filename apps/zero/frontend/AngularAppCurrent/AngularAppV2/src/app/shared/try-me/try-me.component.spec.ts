...
import { TryMeComponent } from './try-me.component';


describe('TryMeComponent', () => {
  let cpnt: TryMeComponent;
  let fixture: ComponentFixture<TryMeComponent>;

  beforeEach(async () => {
    await configureTestingModuleForComponents(TryMeComponent,{mockTranslateService});
    ({fixture, cpnt} =  grabComponentInstance(TryMeComponent));
