...
describe('ProjectsMainComponent', () => {
  let cpnt: ProjectsMainComponent;
  let fixture: ComponentFixture<ProjectsMainComponent>;

  beforeEach(async () => {
    await configureTestingModuleForComponents(ProjectsMainComponent,{mockTranslateService});
    ({fixture, cpnt} =  grabComponentInstance(ProjectsMainComponent));
